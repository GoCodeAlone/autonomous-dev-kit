...
1. **Create Failing Test Case**
   ...
   - Use the `autodev:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **autodev:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **autodev:verification-before-completion** - Verify fix worked before claiming success
