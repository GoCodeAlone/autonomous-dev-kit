...
mkdir -p "$HOME/.config/opencode/autodev"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/autodev/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/autodev/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/autodev/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/autodev.js" "$HOME/.config/opencode/autodev/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/autodev/.opencode/plugins/autodev.js" \
       "$HOME/.config/opencode/plugins/autodev.js"
...
echo "Plugin installed to: $HOME/.config/opencode/autodev/.opencode/plugins/autodev.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/autodev.js"
