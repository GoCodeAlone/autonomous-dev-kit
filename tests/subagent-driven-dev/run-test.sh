...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/autodev
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/autodev-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using autodev:subagent-driven-development. The plan is at: $PLAN_PATH"
