...
| brainstorming | host-conditional | host-conditional | host-conditional | host-conditional | host-conditional | host-conditional | `AskUserQuestion` in `<host: claude-code>`; numbered-list fallback includes Zed; Hermes uses `clarify` |
