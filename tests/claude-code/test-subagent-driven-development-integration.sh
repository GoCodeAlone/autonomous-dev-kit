...
# IMPORTANT: Run from autodev directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"autodev:subagent-driven-development"' "$SESSION_FILE"; then
