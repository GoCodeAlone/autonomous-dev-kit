...
**Date:** 2025-11-28
**Status:** Draft
**Source:** Two Claude instances using autodev in real development scenarios
...
1. Read testing-anti-patterns skill:
   Use Skill tool: autodev:testing-anti-patterns
...
1. **Configuration verification:**
   ...
   - Jon doesn't say "that's not actually testing what you think"
...
**Test Phase 2 with Jon before finalizing:**
